function [jac6] = out_jac67(q)
  ...
  jac6(4,3)=0;
  jac6(4,4)=0;
  jac6(4,5)=q(2)*cos(q(4)) - sin(q(4))*(q(3) + (cos(q(7)) - 1)*(cos(q(4))*cos(q(6)) + sin(q(4))*...
         ...
         sin(q(5)))) + q(3)*sin(q(4));
  jac6(4,6)=cos(q(4))*cos(q(5))*(q(3) + (cos(q(7)) - 1)*(cos(q(4))*cos(q(6)) + sin(q(4))*sin(q(5))*...
  ...
  jac6(5,2)=1;
  jac6(5,3)=0;
  jac6(5,4)=2*cos(q(7))*(cos(q(4))*cos(q(6)) + sin(q(4))*sin(q(5))*sin(q(6))) - (cos(q(5))*...
         sin(q(4)))/10 - (cos(q(7)) - 1)*(cos(q(4))*cos(q(6)) + sin(q(4))*sin(q(5))*sin(q(6))) - sin(q(7))*(cos(q(4))*...
         sin(q(6)) - cos(q(6))*sin(q(4))*sin(q(5)));
  jac6(5,5)=cos(q(4))*(q(1) - sin(q(5))/10 - 2*sin(q(6) + q(7))*cos(q(5)) + cos(q(5))*sin(q(6))*...
         (cos(q(7)) - 1) + cos(q(5))*cos(q(6))*sin(q(7))) - q(1)*cos(q(4));
  jac6(5,6)=sin(q(5))*(q(3) + (cos(q(7)) - 1)*(cos(q(4))*cos(q(6)) + sin(q(4))*sin(q(5))*...
         sin(q(6))) + (cos(q(5))*sin(q(4)))/10 - 2*cos(q(7))*(cos(q(4))*cos(q(6)) + sin(q(4))*sin(q(5))*sin(q(6))) +...
         ...
         cos(q(6))*sin(q(7))) - q(1)*cos(q(5))*sin(q(4));
  jac6(5,7)=sin(q(4))*sin(q(6)) + sin(q(5))*(q(3) + (cos(q(7)) - 1)*(cos(q(4))*cos(q(6)) +...
          sin(q(4))*sin(q(5))*sin(q(6))) + (cos(q(5))*sin(q(4)))/10 - 2*cos(q(7))*(cos(q(4))*cos(q(6)) + sin(q(4))*...
         sin(q(5))*sin(q(6))) + sin(q(7))*(cos(q(4))*sin(q(6)) - cos(q(6))*sin(q(4))*sin(q(5)))) - q(3)*sin(q(5)) +...
          cos(q(5))*sin(q(4))*(q(1) - sin(q(5))/10 - 2*sin(q(6) + q(7))*cos(q(5)) + cos(q(5))*sin(q(6))*(cos(q(7)) -...
          1) + cos(q(5))*cos(q(6))*sin(q(7))) - q(1)*cos(q(5))*sin(q(4)) + cos(q(4))*cos(q(6))*sin(q(5));
  jac6(5,8)=0;
  jac6(5,9)=0;
  jac6(5,10)=0;
  jac6(6,1)=0;
  jac6(6,2)=0;
  jac6(6,3)=1;
  jac6(6,4)=(cos(q(4))*cos(q(5)))/10 - (cos(q(7)) - 1)*(cos(q(6))*sin(q(4)) - cos(q(4))*sin(q(5))*...
         sin(q(6))) + 2*cos(q(7))*(cos(q(6))*sin(q(4)) - cos(q(4))*sin(q(5))*sin(q(6))) - sin(q(7))*(sin(q(4))*...
         sin(q(6)) + cos(q(4))*cos(q(6))*sin(q(5)));
  jac6(6,5)=sin(q(4))*(q(1) - sin(q(5))/10 - 2*sin(q(6) + q(7))*cos(q(5)) + cos(q(5))*sin(q(6))*...
         (cos(q(7)) - 1) + cos(q(5))*cos(q(6))*sin(q(7))) - q(1)*sin(q(4));
  jac6(6,6)=q(2)*sin(q(5)) - sin(q(5))*(q(2) - (cos(q(7)) - 1)*(cos(q(6))*sin(q(4)) - cos(q(4))*...
  ...
  jac6(6,7)=q(2)*sin(q(5)) - sin(q(5))*(q(2) - (cos(q(7)) - 1)*(cos(q(6))*sin(q(4)) - cos(q(4))*...
         sin(q(5))*sin(q(6))) + (cos(q(4))*cos(q(5)))/10 + 2*cos(q(7))*(cos(q(6))*sin(q(4)) - cos(q(4))*sin(q(5))*...
