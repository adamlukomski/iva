...
w.spatial.subplot = subplot( w.geo(1), w.geo(2), 5 );
hold on

w.sagittal.subplot = subplot( w.geo(1), w.geo(2), [1 2 3 4] );
hold on
xlabel('sagittal plane, x')
ylabel('z')

w.frontal.subplot = subplot( w.geo(1), w.geo(2), 6 );
hold on
w.transverse.subplot = subplot( w.geo(1), w.geo(2), 7 );
hold on
w.opts1.subplot = subplot( w.geo(1), w.geo(2), 8 ); % support points
plot( 0, 0, '.b' )
ylim([ 0 eva.n+1] )
hold on
xlabel('t')
...
w.opts2.subplot = subplot( w.geo(1), w.geo(2), 9 );
w.opts3.subplot = subplot( w.geo(1), w.geo(2), 10 );
