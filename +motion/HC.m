...
%  		try 
			Xtree{i} = lie.Ad( [ eye(3) -eva.link(eva.link(eva.link(i).parent).parent).p0+eva.link(eva.link(i).parent).p0; 0 0 0 1 ] ); % yes, the result is negative, -length
